...
public class MySize {
    ...
    final static public int SIZE_COLLISION = 8;
    ...
    final static public int SIZE_HAZARD_2_PXL = SIZE_HAZARD_1_PXL * 2;
    final static public int SIZE_HAZARD_3_PXL = SIZE_HAZARD_1_PXL * 3;
